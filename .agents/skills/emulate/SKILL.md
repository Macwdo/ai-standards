...
```bash
pnpm dlx emulate
# or use the already installed binary:
emulate
```
...
pnpm dlx emulate --service vercel,github

# Custom base port (auto-increments per service)
pnpm dlx emulate --port 3000

# Use a seed config file
pnpm dlx emulate --seed config.yaml

# Generate a starter config
pnpm dlx emulate init

# Generate config for a specific service
pnpm dlx emulate init --service vercel

# List available services
pnpm dlx emulate list
```
